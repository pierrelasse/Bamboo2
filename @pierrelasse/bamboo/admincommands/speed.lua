local PERMISSION = "admin.speed"
local PERMISSION_OTHER = "admin.speed.other"
...
addCommand("speed", function(sender, args)
    ...
    local target = _targets.find(sender, args[2], sender)
    if target == nil then
    ...
    .complete(function(completions, sender, args)
        ...
        elseif #args == 2 then
            _targets.complete(sender, completions, args[2])
        elseif #args == 3 then
            completions.add("fly")
